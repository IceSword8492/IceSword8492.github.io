...
{
  datasets.push({label: member.nickname, backgroundColor: member.backgroundColor, fill: false, borderColor: member.borderColor, data: []});
...
document.getElementById("neetoftheday").innerHTML = todayneetflag ? todayneet[0] : "Not applicable";
